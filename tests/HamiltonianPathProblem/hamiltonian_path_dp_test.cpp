...
TEST(FullyConnectedGraphTest, FullyConnected14Test) {
  generate_fully_connected_graph_test(14);
}
TEST(FullyConnectedGraphTest, FullyConnected15Test) {
  generate_fully_connected_graph_test(15);
}

TEST(FullyConnectedGraphTest, FullyConnected16Test) {
  generate_fully_connected_graph_test(16);
}
TEST(FullyConnectedGraphTest, FullyConnected17Test) {
  generate_fully_connected_graph_test(17);
}
TEST(FullyConnectedGraphTest, FullyConnected18Test) {
  generate_fully_connected_graph_test(18);
}
TEST(FullyConnectedGraphTest, FullyConnected19Test) {
  generate_fully_connected_graph_test(19);
}
TEST(FullyConnectedGraphTest, FullyConnected20Test) {
  generate_fully_connected_graph_test(20);
}

TEST(FullyConnectedGraphTest, FullyConnected21Test) {
  generate_fully_connected_graph_test(21);
}
TEST(FullyConnectedGraphTest, FullyConnected22Test) {
  generate_fully_connected_graph_test(22);
}
TEST(FullyConnectedGraphTest, FullyConnected23Test) {
  generate_fully_connected_graph_test(23);
}
TEST(FullyConnectedGraphTest, FullyConnected24Test) {
  generate_fully_connected_graph_test(24);
}
TEST(FullyConnectedGraphTest, FullyConnected25Test) {
  generate_fully_connected_graph_test(25);
}